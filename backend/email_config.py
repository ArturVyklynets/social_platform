...
async def send_donation_email(to_email: str, amount_uah: float, request_title: str) -> None:
    ...
    <head>
      ...
      <title>Дякуємо за пожертву</title>
    </head>
              ...
              <tr>
                <td style="padding:40px 40px 32px;">
                  ...
                  <p style="margin:0 0 24px;font-size:15px;color:#64748b;line-height:1.6;">
                    Ваша пожертва у розмірі <strong style="color:#4f46e5;">₴{amount_uah:.0f}</strong>
                    на запит <strong style="color:#0f172a;">«{request_title}»</strong>
                    успішно зарахована. Ви допомагаєте тим, хто цього потребує.
                  </p>
                  <p style="margin:0;font-size:13px;color:#94a3b8;line-height:1.6;">
                    Ви можете переглянути статус запиту та звіт про використання коштів
                    у своєму профілі на платформі KindLink.
                  </p>
                </td>
              </tr>
              <tr>
