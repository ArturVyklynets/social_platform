...
import { X, HeartHandshake, DollarSign, ArrowRight, Lock } from "lucide-react"
      ...
      <div className="relative w-full max-w-sm rounded-3xl border border-gray-200 bg-white p-8 shadow-xl">
        ...
        <div className="mb-6 relative">
          ...
          <input
            ...
            className="w-full rounded-xl border border-gray-200 bg-gray-50 py-3 pl-10 pr-4 text-sm text-gray-900 placeholder:text-gray-400 transition-colors focus:border-indigo-600 focus:bg-white focus:outline-none focus:ring-1 focus:ring-indigo-600"
          />
        </div>
